 ...
 */
class IntegralsDipole : public virtual IntegralsOverlap3C {

    protected:
        IntegralsDipole() = default;
    public:
        IntegralsDipole(const IntegralsBase&, const int tol, const uint32_t nR, const std::string& intName = ""); 
    ...
    private:
        ...
        void dipolefun(const int tol, const uint32_t nR, const std::string& intName);
