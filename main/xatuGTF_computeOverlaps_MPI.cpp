...
int main(int argc, char* argv[]){
    ...
    if(procMPI_rank == 0){
        ...
        std::cout << std::endl;
        std::cout << "+---------------------------------------------------------------------------+" << std::endl;
        std::cout << "|                        OVERLAP (2C & 3C) INTEGRALS                        |" << std::endl;
        std::cout << "+---------------------------------------------------------------------------+" << std::endl;
    }
    ...
    int nR = 80;                                     //Minimum number of direct lattice vectors for which the 2-center overlap integrals will be computed
    int nR2 = 80;                                    //Square root of the minimum number of direct lattice vectors for which the 3-center overlap integrals will be computed
    ...
    xatu::IntegralsOverlap2C_MPI Overlap2C(IntBase, procMPI_rank, procMPI_size, tol2C, nR,  savefile); 
    xatu::IntegralsOverlap3C_MPI Overlap3C(IntBase, procMPI_rank, procMPI_size, tol3C, nR2, savefile);    
