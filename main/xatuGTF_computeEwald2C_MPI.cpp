...
int main(int argc, char* argv[]){
    ...
    std::string savefile = "def2-TZVPP-RIFIT";        //Result will be saved in file Results/1-Integrals/E2Mat_savefile.E2c
    ...
    std::vector<int32_t> scalei_supercell = {72,72};  //Scaling factor for the corresponding original (unit cell) Bravais basis vectors Ri to form the supercell
    int nR = 40;                                      //Minimum number of external supercell lattice vectors to be included in the Ewald direct lattice sum
    int nG = 200;                                     //Minimum number of reciprocal supercell vectors to be included in the Ewald reciprocal lattice sum
