 ...
 * @return void.
*/
void SystemTB::solveBands(const arma::colvec& k, arma::colvec& eigval, arma::cx_mat& eigvec) {
...
void SystemTB::brillouinZoneMesh(int n){
	...
	this->kpointsBSE_ = kpoints;
	this->nkBSE_      = kpoints.n_cols;
